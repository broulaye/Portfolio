...
const Work = (props: Props) => {
  ...
  const [filterWork, setFilterWork] = useState<ProjectType[]>([]);
        ...
        {filterWork.map((work, index) => (
          <div className="app__work-item app__flex" key={index}>
            ...
            >
              ...
              >
                <a href={work.linkToBuild} target="_blank" rel="noreferrer">
            ...
            <div className="app__work-content app__flex">
              ...
              <p className="p-text" style={{ marginTop: 10 }}>{work.summary}</p>
